...
>(({ className, onClick, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      {children ? children : (
         <div className="flex items-center text-xs font-medium text-muted-foreground transition-colors hover:text-foreground">
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant, size }), isActive && "bg-sidebar-accent text-sidebar-primary", className)}
        {...props}
      />
    )
